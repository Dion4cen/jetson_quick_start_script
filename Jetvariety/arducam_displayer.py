...
def display(cap, arducam_utils, fps = False, save = False):
    counter = 0
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save', action='store_true', help="save picture")
    ...
    print(args.save)
    # begin display
    display(cap, arducam_utils, args.fps, args.save)
